...
export class UpdateTaskSubCategoryController {
  constructor(
    private updateTaskSubCategoryIdUseCase: UpdateTaskSubCategoryIdUseCase,
    private validation: ValidationService
  ) { }

  @Post("/:taskId/sub-category")
  async handle(
    ...
    const result = await this.updateTaskSubCategoryIdUseCase.execute({
